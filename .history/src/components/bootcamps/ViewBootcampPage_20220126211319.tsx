...
import { useBootcampsList, useViewBootcamp } from 'common/hooks/bootcamps'
...
export default function ViewBootcampPage({ id }: Props) {
  ...
  // const data = { bootcamp: { firstName: 'me', lastName: 'yes' } }
    ...
    <Layout title={data.firstName}>
      <Grid container spacing={6} className={classes.marginTop}>
        <Grid item xs={12} md={8}>
          <Typography className={classes.marginTop}>{data.lastName}</Typography>
        </Grid>
