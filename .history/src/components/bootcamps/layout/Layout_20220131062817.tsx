        ...
        <Drawer variant="permanent" open={open}>
          ...
          <List>
            ...
            <ListItem button>
              ...
              <ListItemText primary={'All bootcamps'} />
              <Button href="/bootcamps"></Button>
            </ListItem>
            <ListItem>
              <IconButton href="/bootcamps/create">
                <AddCircleIcon fontSize="small"></AddCircleIcon> : <MailIcon></MailIcon>
              </IconButton>
              <ListItemText primary={'Add bootcamp'} />
              <Button href="/bootcamps/create"></Button>
            </ListItem>
          </List>
          <Divider />
          <List>
