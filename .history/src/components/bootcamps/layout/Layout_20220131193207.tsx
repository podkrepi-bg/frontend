...
import { Avatar, Button, Collapse, makeStyles, Menu, MenuItem, Tooltip } from '@mui/material'
...
export default function MiniDrawer() {
  ...
  return (
    <>
      <Box sx={{ display: 'flex' }}>
        <CssBaseline />
        <AppBar position="fixed" open={open} className={classes.items}>
          <Toolbar>
            <IconButton
              color="inherit"
            ...
            <img src={'https://i.ibb.co/JvLnt2X/podkrepi-icon.png'} width={50} />
