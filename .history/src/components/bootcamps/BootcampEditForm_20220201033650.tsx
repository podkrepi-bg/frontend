...
export default function EditBootcamp({ initialValues = defaults }: BootcampFormProps) {
  const router = useRouter()
  const { t } = useTranslation()
  const { dataValues } = viewBootcamp(router.query.id)
            ...
            <Grid container spacing={3}>
              <Grid item xs={12}>
                <FormTextField
                  ...
                  name="firstName"
                  autoComplete="name"
                  defaultValue={dataValues.firstName}
                />
              </Grid>
              <Grid item xs={12}>
                <FormTextField
                  ...
                  name="lastName"
                  autoComplete="name"
                  defaultValue={dataValues.lastName}
                />
              </Grid>
              <Grid item xs={12}>
