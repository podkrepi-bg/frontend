...
export const endpoints = {
  ...
  bootcamp: {
    ...
    bootcampsList: <Endpoint>{ url: '/bootcamp/list-all', method: 'GET' },
    viewBootcamp: (id: string) => <Endpoint>{ url: `/bootcamp/list-one/${id}`, method: 'GET' },
    editBootcamp: (id: string) => <Endpoint>{ url: `/bootcamp/update-one/${id}`, method: 'PATCH' },
