...
export const createBootcamp: MutationFunction<AxiosResponse<BootcampResponse>, BootcampInput> =
  ...
  export const editBootcamp: MutationFunction<AxiosResponse<BootcampResponse>, BootcampResponse> =
  async (data: BootcampResponse) => {
    return await axios.patch<BootcampInput, AxiosResponse<BootcampResponse>>(
      endpoints.bootcamp.editBootcamp(data.id).url,
      data,
    )
  }
