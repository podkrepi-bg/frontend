...
export const routes = {
  ...
  bootcamps: {
    home: '/bootcamps/grid/home',
    index: '/bootcamps',
    create: '/bootcamps/create',
    viewBootcampById: (id: string) => `/bootcamps/details/${id}`,
    editBootcampById: (id: string) => `/bootcamps/edit/${id}`,
    deleteBootcamp: `/bootcamps`,
  },
  profile: '/profile',
  register: '/register',
