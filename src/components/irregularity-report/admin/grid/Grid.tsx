...
import { useCampaignReportList } from 'common/hooks/campaignReport'
...
export default observer(function Grid() {
  ...
  const { data }: UseQueryResult<CampaignReportResponse[]> = useCampaignReportList()
      ...
      renderCell: (params: GridRenderCellParams): React.ReactNode => {
        return (
          <GridActions
            ...
            id={params.row.id}
            name={params.row.id}
            editLink={routes.admin.campaignReport.view(params.row.id)}
          />
        )
      },
    },
