            ...
            >
                ...
                <List>
                    <ListItem button sx={{ ":hover": { color: theme.palette.primary.dark } }}>
                        <IconButton sx={{ ":hover": { color: theme.palette.primary.dark } }} onClick={() => { router.push('/city') }}><ListIcon fontSize="small"></ListIcon></IconButton><Button onClick={() => { router.push('/city') }} sx={{ ":hover": { color: theme.palette.primary.main } }}>All cities</Button>
                    </ListItem>
                    <ListItem sx={{ ":hover": { color: theme.palette.primary.dark } }}>
                        <IconButton sx={{ ":hover": { color: theme.palette.primary.dark } }} onClick={() => { router.push('/city/add') }}><AddIcon fontSize="small"></AddIcon></IconButton><Button onClick={() => { router.push('/city/add') }} sx={{ ":hover": { color: theme.palette.primary.main } }}>Add city</Button>
                    </ListItem>
                    <ListItem>
                        <SearchMenu />
                    </ListItem>
