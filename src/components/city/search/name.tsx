  ...
  const onSubmit = async (
    ...
    try {
      ...
      const data = await axios.get(
        "http://localhost:5010/api/city/search/name/" + values.keyword
      );
      setRes(data.data);
      resetForm();
    } catch (error) {
    ...
    <BootcampersLayout>
      ...
      >
        <Grid
          item
          xs={12}
          style={{ marginTop: "10%", marginBottom: "1%", marginLeft: "30%" }}
        >
        ...
        {res.length > 0 ? (
          ...
          <Typography
            style={{ textAlign: "center", fontSize: "20px", marginRight: "4%" }}
          >
            No results
          </Typography>
        )}
