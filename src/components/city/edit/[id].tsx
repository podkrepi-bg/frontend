                ...
                <GenericForm
                    ...
                    <Grid container spacing={1}>
                        ...
                        <Grid item xs={12} style={{ display: "flex", flexDirection: "column", marginLeft: "15%", marginTop: "1.1%" }}>
                            <SubmitButton style={{ width: "50%" }} label="Edit city" loading={mutation.isLoading} sx={{ backgroundColor: theme.palette.secondary.main }} />
                            <Button href="/city" variant="outlined" sx={{ width: "50%", marginTop: "1%", backgroundColor: theme.palette.primary.main, color: theme.palette.background.default }}>Cancel</Button>
                        </Grid>
                        <Grid item xs={12}>
                        </Grid>
                    </Grid>
