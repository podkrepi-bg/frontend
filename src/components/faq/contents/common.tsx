  ...
  },
  {
    ...
    content: (
      <ContentTypography>
        ...
        <p>
          Cлед разговори с чудесни организации с висок кредит на обществено доверие (като DMS,
          Платформата, БДФ, BCause), установихме, че администрирането на дарителски кампании е
        ...
        <p>
          ...
          - Подкрепи.бг се финансира без удържане на комисиони и такси. Издръжката се осигурява
