...
export const COMMON_QUESTIONS: ContentType[] = [
  {
    ...
    content: (
      <ContentTypography>
        <p>
          Подкрепи.бг е платформа за среща между хора, които искат да съберат средства за благородна
          кауза и такива, които искат да ги подкрепят с парични дарения. Подкрепи.бг работи без
          комисиони и такси за дейността си, единствените удръжки от сумите на даренията са такси,
          изисквани от трети лица - финансови и други външни организации или институции.
        </p>
        <p>
          Сдружение Подкрепи.бг работи почти изцяло с доброволци, като разчита и на времменни
  ...
  },
  {
    ...
    content: (
      <ContentTypography>
        <p>
          Накратко - целта ни е да увеличим доверието на обществото в дарителските организации и
          платформи, за да може да се събират по-бързо и лесно необходимите средства за
          осъществяване на кампаниите.
        </p>
        <p>
          Вярваме, че това ще стане чрез комбинация от няколко фактора - безкомпромисна прозрачност,
          модерно технологично решение и нов модел на управление, базиран на доброволческа работа и
          самоиздръжка от дарения и членски внос.
        </p>
        <p>
          Cлед разговори с представители на дарителски организации ползващи се с изключително висок
          кредит на обществено довериe, като БДФ и BCause, които стоят зад едни от най-качествените
          и устойчиви дарителски проекти в страната като{' '}
          <ExternalLink variant="subtitle1" href={staticUrls.dmsBg}>
            {'DMS'}
          </ExternalLink>{' '}
          и{' '}
          <ExternalLink variant="subtitle1" href={staticUrls.platformata}>
            {'Platformata.bg'}
          </ExternalLink>{' '}
          , установихме, че процесът по одобрение и администрирането на дарителските кампании е
          сложна, предимно ръчна и доста времеемка работа. Искаме да решим и този проблем като
          предоставим удобна за ползване онлайн система с автоматизирани процеси за управление на
          паричните средства, издаване на документи и сертификати, справки и др.
        </p>
        <p>
          Както вече споменахме, освен чисто технологично решение, ние предлагаме и нов модел на
          управление на организацията - Подкрепи.бг се финансира без удържане на комисиони и такси
          от кампаниите, а издръжката на сдружението се осигурява от месечен или годишен членски
          внос, както и лични и корпоративни дарения, насочени директно към сдружението.
        </p>
        <p>
          Друга голяма помощ за бюджета на Подкрепи.бг е безплатният доброволчески труд на хората в
          сдружението, както и любезно предоставените ни безплатни услуги от наши партньори, като
          например хостинга ни от{' '}
    ...
    content: (
      <ContentTypography>
        <p>
          ...
          този начин всеки сам може да се увери, че логиката на софтуера изпълнява точно това, за
  ...
  },
  {
    ...
    content: (
      <ContentTypography>
        ...
        напишете тикет в
        <ExternalLink variant="subtitle1" href="https://github.com/podkrepi-bg/frontend/issues">
          {' нашия гитхъб проект!'}
        </ExternalLink>
      </ContentTypography>
    ),
