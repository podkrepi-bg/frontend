    ...
    content: (
      <ContentTypography>
        <p>
          ...
          което организира кампания в своя полза или в полза на друг/и бенефициент/и. Той се
          занимава с осигуряването на документация, комуникация с екипа на Подкрепи.бг, той отговаря
          и за отчетността на усвоените дарения и носи отговорност за рисковете от злоупотреба със
