...
export const data: TeamData[] = [
  {
    ...
    blogUrl: 'https://blog.podkrepi.bg/meet-stanka-cherkezova/',
  ...
  },
  {
    ...
    blogUrl: 'https://blog.podkrepi.bg/meet-ana-nikolova/',
  ...
  },
  {
    ...
    name: 'Юлиян Калдерон',
    description:
      "Над 20 години опит като предприемач (Gamers' Workshop, БГСервиз), 16 години опит в областта на бизнес софтуер nZoom. В нея помагаме на фирмите да бъдат по-успешни, чрез дигитализация и ефективно използване на информационните технологии. От 15 години разработваме собствен бизнес софтуер - nZoom. Като негов архитект имам натрупан значителен опит, който, надявам се, ще бъде от полза в организационен и чисто оперативен план.",
    blogUrl: 'https://blog.podkrepi.bg/meet-julian-kalderon/',
  ...
  },
  {
    ...
    name: 'Диана Добрева',
    description:
      'Над 20 год. опит в организация и управление на финансови потоци, вкл. развитие на 3 новостартиращи в БГ компании със съсредоточен голям финансов ресурс. В последните две години подпомагам стартиращи дружества, които получават инвестиция да си управляват правилно финансовите потоци така, че да прескочат 87% бариера на неуспех вследствие на недобро планиране и разпределение на ресуртите. Обичаща природата и водеща йогийски начин на живот, в който основно място заема дарителството и помощта към другите.',
    blogUrl: 'https://blog.podkrepi.bg/meet-diana-dobreva/',
  ...
  },
  {
    ...
    blogUrl: 'https://blog.podkrepi.bg/meet-radoslav-bozhinov/',
  ...
  },
  {
    ...
    name: 'Иван Гойчев',
    description:
      'Технологичен мениджър с 15 години опит в създаване на успешни стартъпи и реализиране на големи софтуерни продукти. Като технически директор съм водил развитието на 2 успешни стартъпа във финансовата и самолетна индустрия. Натрупах сериозен опит в огромни компании като Amazon AWS, а сега водя софтуерния отдел на Кобилдър за оптимизираме процесите във строителната индустрия.',
    blogUrl: 'https://blog.podkrepi.bg/meet-ivan-goychev/',
