...
export const data: TeamData[] = [
  ...
  },
  {
    ...
    description:
      'Занимава се с дигитална трансформация на бизнес процеси от 1998г. с клиенти на международния пазар. Основател и CEO на SoftConsultGroup, създал и участвал в редица стартъп компании.',
  },
]
