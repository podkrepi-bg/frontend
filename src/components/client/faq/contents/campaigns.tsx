...
export const CAMPAIGN_QUESTIONS: ContentType[] = [
  {
    ...
    content: (
      <ContentTypography>
        ...
        да ни изпратите email на този адрес: campaign_coordinators@podkrepi.bg
      </ContentTypography>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <ContentTypography>
        ...
        всяка уважавана обществена личност или организация, които са външни за платформата ни и са
        запознати с нуждите на кампанията, с организатора и/или бенефициента. Това може да е в
        резултат на съществуващ контакт, запознаване на място или припознаване на каузата.
        Обвързвайки се с кампанията, гарантът помага за популяризирането на каузата и повишаването
        на доверието на дарителите. Той не е материално-отговорно лице по кампанията и не носи
        никаква финансова отговорност за провеждането ѝ и разходването на средствата по нея. Всяка
        кампания може да има повече от един гарант или да няма такъв. Всеки, който иска да стане
        гарант на вече съществуваща кампания или на някоя от подготвящите се, може да ни пише на
        следния имейл: info@podkrepi.bg
      </ContentTypography>
    ),
  },
  {
