    ...
    renderCell: (params: GridValueGetterParams) => {
      return (
        <div>
          ...
          <IconButton
            onClick={() => {
              window.location.pathname = `/bootcamp/edit/${params.row.id}`
            }}
            style={{ color: theme.palette.secondary.main }}>
            <EditIcon></EditIcon>
          </IconButton>
          <IconButton
            onClick={() => DeleteModalStore.show(params.row, 'Delete bootcamper')}
  ...
  return (
    <>
      ...
      <SubmitButton
        ...
        label={`Delete selected bootcampers (${rows.length})`}
