                ...
                <ListItem>
                    <Collapse in={open} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            <ListItem>
                                <Button sx={{ pl: 4, ":hover": { color: theme.palette.primary.main } }} onClick={() => router.push("/bootcamp/search/name")}>
                                    <Typography textAlign="center">Search by name</Typography>
                                </Button>
                            </ListItem>
                            <ListItem>
                                <Button sx={{ pl: 4, ":hover": { color: theme.palette.primary.main } }} onClick={() => router.push("/bootcamp/search/email")}>
                                    <Typography textAlign="center">Search by email</Typography>
                                </Button>
                            </ListItem>
                            <ListItem>
                                <Button sx={{ pl: 4, ":hover": { color: theme.palette.primary.main } }} onClick={() => router.push("/bootcamp/search/phone")}>
                                    <Typography textAlign="center">Search by phone</Typography>
                                </Button>
                            </ListItem>
                            <ListItem>
                                <Button sx={{ pl: 4, ":hover": { color: theme.palette.primary.main } }} onClick={() => router.push("/bootcamp/search/adress")}>
