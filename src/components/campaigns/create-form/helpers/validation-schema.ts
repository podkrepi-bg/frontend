...
export const validationSchema: {
  [key in Steps]?:
    ...
    | yup.SchemaOf<CampaignFormDataSteps[Steps.ORGANIZER]>
    | yup.SchemaOf<CampaignFormDataSteps[Steps.BENEFICIARYTYPE]>
    | yup.SchemaOf<CampaignFormDataSteps[Steps.BENEFICIARY]>
    | yup.SchemaOf<CampaignFormDataSteps[Steps.INFO]>
    | yup.SchemaOf<CampaignFormDataSteps[Steps.DETAILS]>
} = {
  [Steps.NONE]: undefined,
  [Steps.ORGANIZER]: undefined,
  [Steps.BENEFICIARYTYPE]: undefined,
  [Steps.BENEFICIARY]: undefined,
  [Steps.INFO]: undefined,
  [Steps.DETAILS]: undefined,
}
