...
export class SupportPage extends HomePage {
    ...
    private readonly bgAdditionalQuestionsStepText = bgLocalizationSupport.steps['addition-questions'].title;
    private readonly enAdditionalQuestionsStepText = enLocalizationSupport.steps['addition-questions'].title;
    // Step Contact Data
     ...
     */
    async isAdditionalQuestionsStepActive(language: LanguagesEnum = LanguagesEnum.BG): Promise<boolean> {
        if (language === LanguagesEnum.BG) {
