...
export class DonationPage extends CampaignsPage {
    ...
    private readonly bgDonateAnonymouslyText = bgLocalizationOneTimeDonation['second-step']['donate-anonymously'];
    private readonly enDonateAnonymouslyText = enLocalizationOneTimeDonation['second-step']['donate-anonymously'];
    private readonly inputRootSelector = ".MuiInputBase-root";
    private readonly donateAnonymouslyEmailField = this.inputRootSelector + " input[name='personsEmail']";
     // Section labels
     private readonly bgPersonalProfileSectionText = bgLocalizationOneTimeDonation['step-labels']['personal-profile'];
     private readonly enPersonalProfileSectionText = enLocalizationOneTimeDonation['step-labels']['personal-profile'];
