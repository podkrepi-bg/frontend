...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Campaign.organizer":
		if e.complexity.Campaign.Organizer == nil {
			break
		}

		return e.complexity.Campaign.Organizer(childComplexity), true
	...
	case "Mutation.createCampaign":
		...
		return e.complexity.Mutation.CreateCampaign(childComplexity, args["input"].(model.CreateCampaign)), true
...
func (ec *executionContext) _Campaign_organizer(ctx context.Context, field graphql.CollectedField, obj *model.Campaign) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Mutation_createCampaign(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateCampaign(rctx, args["input"].(model.CreateCampaign))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputCreateCampaign(ctx context.Context, obj interface{}) (model.CreateCampaign, error) {
	var it model.CreateCampaign
	var asMap = obj.(map[string]interface{})
	...
	for k, v := range asMap {
		...
		case "organizerId":
			...
			it.OrganizerID, err = ec.unmarshalNString2string(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) _Campaign(ctx context.Context, sel ast.SelectionSet, obj *model.Campaign) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "organizer":
			out.Values[i] = ec._Campaign_organizer(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "createCampaign":
			out.Values[i] = ec._Mutation_createCampaign(ctx, field)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
